...
if(runinit)
{
SimR1fitring0.year = stan(file="../stan/agereader_year_strat0.stan",data=d.comb0,
                        iter=50000,chains=4,thin=25)
save(SimR1fitring0.year,file="SimR1fitring0.year50000.RData")
}
if(!runinit)
 load("SimR1fitring0.year50000.RData")

simext = rstan::extract(SimR1fitring0.year)
...
SimR1fitcomb0.year = stan(file="../stan/agereader_comb_year_strat0.stan",data=d.comb,
                    iter=100000,chains=4,thin=100,init=init2)
save(SimR1fitcomb0.year,file="SimR1fitcomb0.year100000.RData")
