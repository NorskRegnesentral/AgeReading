...
for(m in 3:Nsim)
{
  ...
  save(simfitring1.year,file=paste0("../save_results/Simfitring1Mbar_indM.",m,".",Nmcmc/2,".RData"))
  ...
  save(simfitcomb1.year,file=paste0("../save_results/simfitcomb1Mbar_indM",m,".",format(Nmcmc,scientific=F),".RData"))
}
...
{
  print(m)
  load(paste0("../save_results/simfitcomb1Mbar_indM",m,".",format(Nmcmc,scientific=F),".RData"))              #reader dependent age errors
...
for(y in 1:3)
{
  pdf(paste0("Sim_Mbar_N_year_indM",2020+y,".pdf"),height=5,width=10)
