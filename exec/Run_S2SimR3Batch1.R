...
data(S2SimR3.Ring.readErr)
dataRing = S2SimR3.Ring.readErr
data(S2SimR3.HerringSurvey)
df = S2SimR3.HerringSurvey
...
S2SimR3fitcomb1.year = stan(file="../stan/agereader_comb_year_strat1.stan",data=d.comb,
                    iter=100000,chains=4,thin=100)
save(S2SimR3fitcomb1.year,file="S2SimR3fitcomb1.year100000.RData")
