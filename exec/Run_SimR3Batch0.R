...
data(SimR3.Ring.readErr)
dataRing = SimR3.Ring.readErr
data(SimR3.HerringSurvey)
df = SimR3.HerringSurvey
...
if(runinit)
{
SimR3fitring0.year = stan(file="../stan/agereader_year_strat0.stan",data=d.comb0,
                        iter=50000,chains=4,thin=25)
save(SimR3fitring0.year,file="SimR3fitring0.year50000.RData")
}
if(!runinit)
 load("SimR3fitring0.year50000.RData")

simext = rstan::extract(SimR3fitring0.year)
...
SimR3fitcomb0.year = stan(file="../stan/agereader_comb_year_strat0.stan",data=d.comb,
                    iter=100000,chains=4,thin=100,init=init2)
save(SimR3fitcomb0.year,file="SimR3fitcomb0.year100000.RData")
