...
data(S2SimR6.Ring.readErr)
dataRing = S2SimR6.Ring.readErr
data(S2SimR6.HerringSurvey)
df = S2SimR6.HerringSurvey
...
S2SimR6fitcomb1.year = stan(file="../stan/agereader_comb_year_strat1.stan",data=d.comb,
                    iter=100000,chains=4,thin=100)
save(S2SimR6fitcomb1.year,file="S2SimR6fitcomb1.year100000.RData")
