...
data(Sim3.Ring.readErr)
dataRing = Sim3.Ring.readErr
data(Sim3.HerringSurvey)
df = Sim3.HerringSurvey
...
Sim3fitcomb1.year = stan(file="../stan/agereader_comb_year_strat1.stan",data=d.comb,
                    iter=100000,chains=4,thin=100)
save(Sim3fitcomb1.year,file="Sim3fitcomb1.year100000.RData")
