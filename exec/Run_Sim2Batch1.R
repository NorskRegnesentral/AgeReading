...
data(Sim2.Ring.readErr)
dataRing = Sim2.Ring.readErr
data(Sim2.HerringSurvey)
df = Sim2.HerringSurvey
...
sim2fitcomb1.year = stan(file="../stan/agereader_comb_year_strat1.stan",data=d.comb,
                    iter=100000,chains=4,thin=100)
save(sim2fitcomb1.year,file="sim2fitcomb1.year100000.RData")
