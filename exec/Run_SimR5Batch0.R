...
if(runinit)
{
SimR5fitring0.year = stan(file="../stan/agereader_year_strat0.stan",data=d.comb0,
...
SimR5fitcomb0.year = stan(file="../stan/agereader_comb_year_strat0.stan",data=d.comb,
